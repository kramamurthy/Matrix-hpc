...
public:
	...
	int initializeTasks(int num_tasks, int numSleep, int mode, int max_tasks_per_package, ZHTClient &clientRet, int DAG_choice,int num_of_cores);
	pthread_t monitor(int num_tasks, ZHTClient &clientRet, int num_of_cores);
};
